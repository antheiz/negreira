...
$data = json_decode(file_get_contents("kelurahan.geo.json"), true);
...
foreach ($data["features"] as $feature) {
    ...
    $query = "INSERT INTO kelurahan (id, kecamatan_id, nama_kelurahan, peta_kelurahan, created_at) VALUES (?, ?, ?, ST_GeomFromGeoJSON(?), NOW())";
